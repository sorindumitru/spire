...
| NodeAttestor       | [k8s_resource](/doc/plugin_server_nodeattestor_k8s_resource.md)                                      | A node attestor which attests agent identity using a Kubernetes Projected Service Account token and authorizes declared resource access via SubjectAccessReview |
