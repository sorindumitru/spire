...
## How to create a registration entry
...
You register a workload either by issuing the `spire-server entry create` command at the command line or calling directly into the Entry API, as described in the [Entry API documentation](https://github.com/spiffe/spire-api-sdk/blob/main/proto/spire/api/server/entry/v1/entry.proto). Existing entries can be modified using the `spire-server entry update` command.
...
To learn more about the `spire-server entry create` and `spire-server entry update` commands and options, consult the [SPIRE Server reference guide](spire_server.md).
...
| --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Kubernetes**                                      | The [configuration reference page for the Kubernetes Node Attestor](plugin_server_nodeattestor_k8s_psat.md)                       |
| **AWS**                                             | The [configuration reference page for the AWS Node Attestor](plugin_server_nodeattestor_aws_iid.md)                              |
| **Azure**                                           | The [configuration reference page for the Azure Managed Service Identity Node Attestor](plugin_server_nodeattestor_azure_msi.md) |
...
| For a list of supported selectors for this platform | Go here                                                                                                                                                                           |
|-----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Unix**                                            | The [configuration reference page for the Unix Workload Attestor](plugin_agent_workloadattestor_unix.md)      |
| **Kubernetes**                                      | The [configuration reference page for the Kubernetes Workload Attestor](plugin_agent_workloadattestor_k8s.md) |
| **Docker**                                          | The [configuration reference page for the Docker Workload Attestor](plugin_agent_workloadattestor_docker.md)  |
...
> **Note**
> Each registration entry has a single, unique Registration Entry ID, but multiple registration entries may specify the same SPIFFE ID.
...
To learn more about the `spire-server entry show` command and options, consult the [SPIRE Server reference guide](spire_server.md).
...
To learn more about the `spire-server entry delete` command and options, consult the [SPIRE Server reference guide](spire_server.md).
...
Once you've learned how to create, update and delete registration entries, consider reviewing the guide on [How to use SVIDs](https://spiffe.io/docs/latest/deploying/svids/).
