...
SPIRE comes with a set of built-in Node Attestor plugins for the [Server](spire_server.md) and [Agent](spire_agent.md) that support various cloud platforms, schedulers and other machine identity sources. Servers can have multiple Node Attestor plugins enabled simultaneously, however a given Agent may only have one Node Attestor plugin enabled at a time.
...
SPIRE comes with a set of built-in Workload Attestor plugins for the [Agent](spire_agent.md).
...
SPIRE comes with a set of built-in UpstreamAuthority plugins for the [Server](spire_server.md).
...
SPIRE comes with a set of built-in Key Manager plugins for the [Server](spire_server.md) and [Agent](spire_agent.md).
...
SPIRE comes with a set of built-in Notifier plugins for the [Server](spire_server.md) and [Agent](spire_agent.md).
...
*   For instructions on modifying the Server and Agent configuration files, please follow [Configuring the SPIRE Server](configuring.md).
*   For more information on enabling the plugins in the Server, read the [Server configuration guide](spire_server.md).
*   For more information on enabling the plugins in the Agent, read the [Agent configuration guide](spire_agent.md).
